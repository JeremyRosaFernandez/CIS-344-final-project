    ...
    def do_POST(self):
        try:
            ...
            if self.path == '/scheduleAppointment':
                ...
                # Call the Database Method to schedule a new appointment.
                # Example call: self.database.scheduleAppointment(patient_id, doctor_id, appointment_date, appointment_time)
                ...
                self.wfile.write(b"<div><a href='/'>Home</a>| \
                              ...
                              <a href='/dischargePatient'>Discharge Patient</a></div>")
                self.wfile.write(b"<hr>")
                self.wfile.write(b"<h3>Appointment has been scheduled</h3>")
            ...
            if self.path == '/dischargePatient':
                ...
                # Example call: self.database.dischargePatient(patient_id)
